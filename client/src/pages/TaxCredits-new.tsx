...
// 유효성 검사 스키마 생성 (간단한 스키마)
const taxCreditsSchema = z.object({
  childTaxCredit: z.number().min(0).default(0),
  childDependentCareCredit: z.number().min(0).default(0),
  educationCredits: z.number().min(0).default(0),
  retirementSavingsCredit: z.number().min(0).default(0),
