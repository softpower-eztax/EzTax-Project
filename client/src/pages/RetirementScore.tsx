                          ...
                          <CardHeader>
                            ...
                            <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4 mt-4">
                              <p className="text-sm text-yellow-800">
                                ...
                                정확한 혜택 금액은 <a href="https://www.ssa.gov" target="_blank" rel="noopener noreferrer" className="text-blue-600 underline hover:text-blue-800 font-medium">SSA.gov</a>에서 확인하시기 바랍니다.
                              </p>
                            </div>
                          </CardHeader>
