...
Recent Changes:
- July 12, 2025: **USER INTERFACE CLARITY IMPROVEMENTS** - Enhanced retirement score form with clearer field labeling: "가족 상태" → "결혼상태", "부양가족 수" → "현재 부양가족 수", "비상 자금" → "현재 보유 비상 자금", "은퇴 후 예상 생활비" → "은퇴 후 예상 생활비 (월 비용, 주거비 포함)" for better user understanding and accurate data input
