...
export const koMessages: Messages = {
  ...
  home: {
    ...
    readyToFile: "세금 신고 준비가 되셨나요?",
    learnMoreAbout: "EzTax와 운영진에 대해 더 알아보기 →",
    features: {
    ...
    featureDescriptions: {
      ...
      retirementPlanning:
        "개인별 맞춤 은퇴 설계와 세금 최적화 전략을 제공합니다.",
      safeAndPrivate:
        "귀하의 데이터는 은행 수준의 보안으로 암호화되어 보호됩니다.",
    },
    ...
    stepDescriptions: {
      personalInfo: "기본 정보 및 신고 상태",
      income: "급여, 이자, 기타 소득 입력",
      deductions: "표준 공제 또는 항목별 공제 선택",
      taxCredits: "자격이 있는 공제 항목 확인",
      additionalTax: "자영업 및 기타 소득",
      review: "최종 확인 및 신고서 생성",
    },
  },
  ...
  about: {
    ...
    founderCredentials:
      "미 Midwest 대학 회계학 교수, University of Pennsylvania Economics, Yonsei University MBA",
...
export const enMessages: Messages = {
  ...
  home: {
    ...
    subtitle: "Less Tax, More Wealth",
    tagline:
      "Calculate taxes easily with our simulator and diagnose your retirement readiness",
    startNowButton: "Get Started",
    taxSimulatorButton: "Tax Simulator",
    retirementDiagnosisButton: "Retirement Readiness Assessment",
    description:
      "Professional and accurate tax calculation and retirement planning services",
    whyEzTax: "Why Choose EzTax?",
    processDescription:
      "Our simple process guides you through six easy sections:",
    readyToFile: "Ready to File Your Taxes?",
    learnMoreAbout: "Learn more about EzTax and our team →",
    features: {
    ...
    featureDescriptions: {
      ...
      retirementPlanning:
        "Personalized retirement planning and tax optimization strategies.",
      safeAndPrivate:
    ...
    stepDescriptions: {
      personalInfo: "Basic information and filing status",
      income: "Enter wages, interest, and other income",
      deductions: "Choose standard or itemized deductions",
      taxCredits: "Verify eligible credit items",
      additionalTax: "Self-employment and other income",
      review: "Final verification and return generation",
    },
  },
  ...
  personalInfo: {
    ...
    noDependents:
      "No dependents added. Click the button above to add dependents.",
    dependent: "Dependent",
    dependentName: "Name",
  ...
  retirementScore: {
    ...
    emergencyFund: "Current Emergency Fund",
    retirementExpenses:
      "Expected Retirement Living Expenses (Monthly including housing $)",
  ...
  about: {
    ...
    founderCredentials:
      "Professor of Accounting at Midwest University, University of Pennsylvania Economics, Yonsei University MBA",
  ...
  auth: {
    ...
    passwordRequirements:
      "Password must be 8+ characters with uppercase and special characters",
  },
