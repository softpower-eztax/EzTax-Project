      ...
      {!analysis ? (
        ...
        <div className="space-y-6">
          ...
          {analysis.score < 80 && (
            <div className="space-y-6">
              {/* CEO Introduction */}
              <Card className="border-primary/30 bg-gradient-to-r from-primary/10 to-blue-100">
                <CardHeader>
                ...
                <CardContent>
                  <div className="bg-white/80 p-6 rounded-lg">
                    <div className="text-center mb-4">
                      ...
                      <h3 className="text-xl font-bold text-primary mb-1">EzTax 창립자 & CEO</h3>
                      <p className="text-primary/70 font-medium">혁신적 핀테크 세무·은퇴 플랫폼 개발자</p>
                    </div>
                    ...
                    <div className="text-center text-gray-700 leading-relaxed">
                      ...
                      <p className="mb-3">
                        복잡한 세무와 은퇴 계획을 <strong>쉽고 정확하게</strong> 만들어 
                        모든 사람이 더 나은 재정적 미래를 설계할 수 있도록 돕고 있습니다.
                      </p>
                ...
                <CardContent>
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-blue-700 font-medium mb-3">
                      미국 세무·투자 전문가 | 전직 재무임원 | 『Less Tax, More Wealth』 저자
                    </p>
