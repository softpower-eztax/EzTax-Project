...
Recent Changes:
- June 25, 2025: **HOMEPAGE BUTTON TEXT SIZE UNIFIED** - Made all homepage buttons use font-bold class to match "지금 시작하기" button text weight for consistent visual appearance
