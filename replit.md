...
Recent Changes:
- June 25, 2025: **PERSONAL INFO SAMPLE DATA BUTTON FIXED** - Fixed "예시 데이터" button by using individual form.setValue() calls instead of form.reset() for reliable field population
