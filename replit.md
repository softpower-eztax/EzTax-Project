...
Recent Changes:
- June 24, 2025: **GOOGLE OAUTH REMOVED** - Removed Google login functionality and associated UI elements for cleaner authentication experience, users can use regular login/signup or guest access
