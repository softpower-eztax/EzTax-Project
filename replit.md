...
Recent Changes:
- July 3, 2025: **SCHEDULE D SUMMARY SYSTEM COMPLETELY IMPLEMENTED** - Transformed Capital Gains Calculator from individual transaction focus to IRS-compliant Schedule D Summary format, displaying Short-term/Long-term totals with Proceeds, Cost Basis, Wash Sale Loss Disallowed, and Net Gain/Loss in official Form 8949 layout with collapsible individual transaction details
